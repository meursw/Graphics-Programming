...
bool SystemClass::Frame() {
	...
	if (m_Input->isKeyDown(VK_TAB)) {
		if (!m_isMouseCursorLocked) { // Lock the mouse cursor to the center
			CenterCursor(m_hwnd);
		}
		m_isMouseCursorLocked = !m_isMouseCursorLocked;
	}	

	if (m_isMouseCursorLocked)
	{
