...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vysnc, HWND hwnd, bool fullscreen, float screenDepth, float screenNear) {
	...
	D3D11_BLEND_DESC blendStateDescription; // Describes a blend state.
	...
	////// START GETTING INFORMATION ABOUT THE MONITOR AND VIDEO CARD and storing it to member variables.
