...
bool NormalMapShaderClass::InitializeShaderDerived(ID3D11Device* device)
{
    HRESULT result;
...
bool NormalMapShaderClass::SetShaderParametersDerived(ID3D11DeviceContext* deviceContext)
{
    HRESULT result;
    ...
    dataPtr->diffuseColor = m_diffuseColor;
    dataPtr->lightDirection = m_lightDirection;
...
void NormalMapShaderClass::RenderShaderDerived(ID3D11DeviceContext* deviceContext)
{
