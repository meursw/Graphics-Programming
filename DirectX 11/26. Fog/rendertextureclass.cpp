...
{
    // Bind the render target view and depth stencil buffer to the output render pipeline. OM = Output-Merger
    deviceContext->OMSetRenderTargets(1, &m_renderTargetView, m_depthStencilView);

    // Set the viewport. RS = Rasterizer Stage
