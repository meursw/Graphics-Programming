...
bool ApplicationClass::Initialize(int screenWidth, int screenHeight, HWND hwnd) {
	...
	strcpy_s(textureFilename3, "../DX11/Assets/Textures/alpha01.tga");
	m_Model = new ModelClass;
	if (!m_Model->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), modelFilename, textureFilename1, textureFilename2, textureFilename3)) {
...
bool ApplicationClass::Render()
{
	...
	result = m_MultiTextureShader->Render(m_Direct3D->GetDeviceContext(), m_Model->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
		m_Model->GetTexture(0), m_Model->GetTexture(1), m_Model->GetTexture(0));
