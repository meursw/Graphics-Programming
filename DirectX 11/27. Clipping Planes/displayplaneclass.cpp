...
{
    // Put the vertex and index buffers in the pipeline to prepare them for drawing.
...
void DisplayPlaneClass::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
    ...
    // Set the primitive that should be rendered from this vertex buffer, in this case triangles.
