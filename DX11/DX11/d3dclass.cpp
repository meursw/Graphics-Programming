...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	// All this code just gets the refresh rate of the users monitor.
	...
	factory->Release();
	factory = 0;
	// -- We now have the refresh rate of the users monitor --
	
	// Start DX11 initialization
	// Initialize the swap chain description ( front and back buffers for rendering ).
