...
glm::vec3 lightPos(2.1f, 0.62, 2.0f);
...
int main() {
    ...
    Shader lightingShader("2. Lighting/2.4. Lighting Maps/lighting_maps.vert", "2. Lighting/2.4. Lighting Maps/lighting_maps.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 diffuseColor = lightColor * glm::vec3(0.7);
        glm::vec3 ambientColor = diffuseColor * glm::vec3(0.3);
        lightingShader.setVec3("light.ambient", ambientColor);
        lightingShader.setVec3("light.diffuse", diffuseColor);
        lightingShader.setVec3("light.specular", 1.0f, 1.0f, 1.0f);

        lightPos.x -= sin(glfwGetTime()*1.5)*0.01;
        lightPos.z -= cos(glfwGetTime()*1.5)*0.01;
