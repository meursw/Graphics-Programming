...
int main() {
    ...
    Shader lightingShader("2. Lighting/2.6. Multiple Lights/multiple_lights.vert", "2. Lighting/2.6. Multiple Lights/multiple_lights.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("spotLight.constant", .04f);
        ...
        lightingShader.setFloat("spotLight.outerCutOff", glm::cos(glm::radians(5.0f)));
