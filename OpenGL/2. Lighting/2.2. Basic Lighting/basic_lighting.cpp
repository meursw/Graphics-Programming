...
glm::vec3 lightPos(1.1f, 0.52, 0.0f);
...
int main() {
    ...
    Shader lightingShader("2. Lighting/2.2. Basic Lighting/basic_lighting.vert", "2. Lighting/2.2. Basic Lighting/basic_lighting.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPos.x -= SIN(1.0f)*0.01;
        lightPos.z -= COS(1.0f)*0.01;
