...
int main() {
    ...
    Shader lightingShader("2. Lighting/2.3. Materials/materials.vert", "2. Lighting/2.3. Materials/materials.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightColor.y = sin(glfwGetTime() * 2.7f);
        ...
        //lightPos.x -= sin(glfwGetTime())*0.01;
        //lightPos.z -= cos(glfwGetTime())*0.01;
